...
namespace zero::render
{
    ...
    public:
         ...
         */
        static std::unique_ptr<Mesh> GenerateSphere(const Sphere& sphere);
         ...
         */
        static std::unique_ptr<Mesh> GeneratePlane(const Plane& plane);

        /**
         * @brief Generate the mesh of a box with 24 vertices
         * @return the mesh of a 3D box
         */
        static std::unique_ptr<Mesh> GenerateBox();
         ...
         */
        static std::unique_ptr<Mesh> GenerateTorus(const Torus& torus);
         ...
         */
        static std::unique_ptr<Mesh> GenerateCone(const Cone& cone);
         ...
         */
        static std::unique_ptr<Mesh> GenerateCylinder(const Cylinder& cylinder);
    ...
    private:
         ...
         */
        static std::unique_ptr<Mesh> GenerateCylinderCap(const Cylinder& cylinder, uint32& index, bool isTopCap);
