...
Entity TestRegistry::GenerateHumanoid(math::Vec3f position, float parent_radius)
{
    ...
    registry_.emplace<Transform>(body_entity, body_transform);
    registry_.emplace<Volume>(body_entity, position, parent_radius);

    // Head - 4 units above body
    Entity head_entity = registry_.create();
    math::Vec3f head_offset(0.0F, 4.0F, 0.0F);
    registry_.emplace<Transform>(head_entity,
                                body_entity,
                                body_transform,
                                head_offset,
                                math::Vec3f::One(),
                                math::Quaternion());
    registry_.emplace<Volume>(head_entity,
    ...
    registry_.emplace<Transform>(left_arm_entity,
                                body_entity,
                                body_transform,
                                left_arm_offset,
                                math::Vec3f::One(),
                                math::Quaternion());
    registry_.emplace<Volume>(left_arm_entity,
    ...
    registry_.emplace<Transform>(right_arm_entity,
                                body_entity,
                                body_transform,
                                right_arm_offset,
                                math::Vec3f::One(),
                                math::Quaternion());
    registry_.emplace<Volume>(right_arm_entity,
    ...
    registry_.emplace<Transform>(left_leg_entity,
                                body_entity,
                                body_transform,
                                left_leg_offset,
                                math::Vec3f::One(),
                                math::Quaternion());
    registry_.emplace<Volume>(left_leg_entity,
    ...
    registry_.emplace<Transform>(right_leg_entity,
                                body_entity,
                                body_transform,
                                right_leg_offset,
                                math::Vec3f::One(),
                                math::Quaternion());
    registry_.emplace<Volume>(right_leg_entity,
