...
TEST(TestMatrix3, ScalarOperations) {
	...
	EXPECT_EQ(Matrix3x3(2.0f, 1.0f, 1.0f,
	                    1.0f, 2.0f, 1.0f,
	                    1.0f, 1.0f, 2.0f), matrix + 1.0f);

	EXPECT_EQ(Matrix3x3(0.0f, -1.0f, -1.0f,
	                    -1.0f, 0.0f, -1.0f,
	...
	EXPECT_EQ(Matrix3x3(1.0f, 0.5f, 0.5f,
	                    0.5f, 1.0f, 0.5f,
	...
	matrix -= 4.0f;
	EXPECT_EQ(Matrix3x3(-2.0f, -3.0f, -3.0f,
	                    -3.0f, -2.0f, -3.0f,
	                    -3.0f, -3.0f, -2.0f), matrix);

	matrix *= 10.0f;
	EXPECT_EQ(Matrix3x3(-20.0f, -30.0f, -30.0f,
	                    -30.0f, -20.0f, -30.0f,
...
TEST(TestMatrix3, MatrixMatrixAddition) {
	...
	EXPECT_EQ(Matrix3x3(3.0f, 1.0f, 1.0f,
	                    1.0f, 3.0f, 1.0f,
...
TEST(TestMatrix3, MatrixMatrixSubtraction) {
	...
	EXPECT_EQ(Matrix3x3(-1.0f, -1.0f, -1.0f,
	                    -1.0f, -1.0f, -1.0f,
...
TEST(TestMatrix3, Hadamard) {
	...
	EXPECT_EQ(Matrix3x3(1.0f, 4.0f, 9.0f,
	                    16.0f, 25.0f, 36.0f,
	                    49.0f, 64.0f, 81.0f), Matrix3x3::Hadamard(m1, m2));
}
...
TEST(TestMatrix3, Det) {
	...
	EXPECT_EQ(-216.0f, (Matrix3x3::Hadamard(m1, m1)).Det());
...
TEST(TestMatrix3, Inverse) {
	...
	EXPECT_EQ(Matrix3x3(0.0f), Matrix3x3(1.0f).Inverse());
	EXPECT_EQ(Matrix3x3(0.75f, -0.25f, -0.25f,
	                    -0.25f, 0.75f, -0.25f,
...
TEST(TestMatrix3, Transpose) {
	...
	EXPECT_EQ(Matrix3x3(1.0f, 16.0f, 49.0f,
	                    4.0, 25.0, 64.0f,
...
TEST(TestMatrix3, MatrixMatrixMultiply) {
	...
	EXPECT_EQ(Matrix3x3(56.0f, 225.0f, 100.0f,
